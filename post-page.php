              ...
              if($_SESSION['lang'] === 'en'){
               ...
               $start2 = ($page2 > 1) ? ($page2 * $limit2) - $limit2 : 0;
                ...
                foreach ($results2 as $row) {
                    ...
                    <a href="single.php?url=<?php echo $row['slug']; ?>"><h4 style="color: #1e5fa6;line-height: 40px;" class="card-title"><?php echo $titel ?></h4></a>
