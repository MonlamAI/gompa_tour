...
<div style="width: 97%!important;" class="container">
  ...
  <div class="row">
    ...
    <div class="col-lg-8">
            ...
            <form action="post-page.php" style="margin-top: 18px;" class="input-group custom-search-form">
        ...
        <input name="posts" value="posts" type="checkbox" class="form-check-input" id="exampleCheck1" checked>
        <label class="form-check-label" for="exampleCheck1"><?php echo htmlspecialchars(translate('article'), ENT_QUOTES, 'UTF-8'); ?> </label>
            ...
            if (isset($_GET['search']) && !empty($_GET['search'])) {
               ...
               $start = ($page > 1) ? ($page * $limit) - $limit : 0;
                ...
                $sql = "SELECT *, MATCH(tbtitle, entitle) AGAINST(:searchTerm IN NATURAL LANGUAGE MODE) AS score FROM posts WHERE MATCH(tbtitle, entitle) 
                ...
                $totalSql = "SELECT COUNT(*) FROM posts WHERE MATCH(tbtitle, entitle) AGAINST(:searchTerm IN NATURAL LANGUAGE MODE)";
                ...
                foreach ($results as $row) {
                    ...
                    <a href="tensum.php?url=<?php echo $row['slug']; ?>"><h4 style="color: #1e5fa6; text-overflow: ellipsis!important; display: -webkit-box!important; max-height: 35px; -webkit-line-clamp: 2; margin: 1px; height: 35px; font-size: 23px;" class="card-title"><?php echo $titel ?></h4></a>
              ...
              if($_SESSION['lang'] === 'en'){
               ...
               $start2 = ($page2 > 1) ? ($page2 * $limit2) - $limit2 : 0;
                ...
                // Prepare the full-text search query
                $sql2 = "SELECT * FROM posts ORDER BY $titel DESC LIMIT :start, :limit";
                ...
                // Calculate total pages
                $totalSql2 = "SELECT COUNT(*) FROM posts ";
                ...
                foreach ($results2 as $row) {
                    ...
                    <a href="single.php?url=<?php echo $row['slug']; ?>"><h4 style="color: #1e5fa6; text-overflow: ellipsis!important; display: -webkit-box!important; max-height: 35px; -webkit-line-clamp: 2; margin: 1px; height: 35px; font-size: 23px;" class="card-title"><?php echo $titel ?></h4></a>
                       
                        <div style="border-bottom: 1px solid #ececec;min-height: 110px;">
                        <img style="width: 100%;object-fit: cover;flo;float: left;object-position: top;margin-right: 6px;position: relative;top: 8px;" class="img-fluid rounded" src="<?php echo $baseUrl ?>/<?php echo $row['pic']; ?>" alt="">  
