                        ...
                        <div class="col-lg-12">
                            <form role="form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="event_tbname" placeholder="བོད་ཡིག་མཚན་བྱང་འགོད་རོགས།" value="<?php if(isset($post['event_tbname'])){ echo $post['event_tbname'];} ?>">
                                </div>
                                <div class="form-group">
                                    <label>དབྱིན་ཡིག་མཚན་བྱང་།</label>
                                    <input class="form-control" id="event_enname" name="event_enname" oninput="updateSlug()"placeholder="དབྱིན་ཡིག་མཚན་བྱང་འགོད་རོགས།" value="<?php if(isset($post['event_enname'])){ echo $post['event_enname'];} ?>">
                                ...
                                <div class="row">
                                    <div class="col-sm-6"> 
                                        <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                            ...
                                            <input value="<?php echo date('Y-m-d', strtotime($post['start_date'])); ?>" class="form-control" name="start_date" data-date-format="m/d/Y" id="datepicker">
                                    ...
                                    <div class="col-sm-6"> 
                                        <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                            ...
                                            <input value="<?php echo date('Y-m-d', strtotime($post['end_date'])); ?>" class="form-control" name="end_date" data-date-format="m/d/Y" id="datepicker1">               
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>བོད་ཡིག་འགྲེལ་བཤད།</label>
                                    <textarea style="line-height: 28px;" class="form-control" name="tb_description" rows="3"><?php if(isset($post['tb_description'])){ echo $post['tb_description'];} ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label>དབྱིན་ཡིག་འགྲེལ་བཤད།</label>
                                    <textarea style="line-height: 28px;" class="form-control" name="en_description" rows="3"><?php if(isset($post['en_description'])){ echo $post['en_description'];} ?></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6"> 
                                    <label>སྡེ་ཚན་དབྱེ་བ།</label>
                                        <input type="text" class="form-control custom-font-input" value="<?php if(isset($post['categories'])){ echo $post['categories'];} ?>" name="categories" placeholder="Enter the categories" list="list-timezone" id="input-datalist1">
                                    ...
                                    <input class="form-control" name="location" placeholder="Enter Location Here" value="<?php if(isset($post['location'])){ echo $post['location'];} ?>">
