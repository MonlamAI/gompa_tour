...
if (isset($_POST) & !empty($_POST)) {
    ...
    if (empty($_POST['categories'])) {
        $errors[] = "Call Number Field is Required";
    }
                        ...
                        <div class="col-lg-12">
                            <form role="form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="tbtitle" placeholder="Enter Article Title" value="<?php if (isset($post['tbtitle'])) {
                                        echo $post['tbtitle'];
                                    } ?>">
                                </div>
                                <div class="form-group">
                                    <label>Article En Title</label>
                                    <input id="entitle" class="form-control" oninput="updateSlug()" name="entitle"
                                        placeholder="Enter Article Title" value="<?php if (isset($post['entitle'])) {
                                            echo $post['entitle'];
                                        } ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="tbcontent" rows="3"><?php if (isset($post['tbcontent'])) {
                                        echo $post['tbcontent'];
                                    } ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Article En Content</label>
                                    <textarea class="form-control" name="encontent" rows="3"><?php if (isset($post['encontent'])) {
                                        echo $post['encontent'];
                                    } ?></textarea>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select multiple="" name="categories[]" class="form-control">
                                                <?php
                                                foreach ($res as $cat) {
                                                    if (in_array($cat['id'], array_column($categories, 'cid'))) {
                                                        $selected = "selected";
                                                    } else {
                                                        $selected = "";
                                                    }
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="slug" class="form-control" name="slug" placeholder="སྦེལ་ཐག་་་" value="<?php if (isset($post['slug'])) {
                                        echo $post['slug'];
                                    } ?>">
                                </div>
