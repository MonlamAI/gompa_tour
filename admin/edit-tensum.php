                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form role="form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div id="imageTypeError" style="color: red; display: block; margin-top: 10px;">
                                            པར་རིས་ JPEG རྣམ་ཅན་ཁོ་ན་ལས་ངོས་ལེན་མི་བྱེད།</div>
                                    <?php endif; ?>
                                ...
                                <div class="form-group">
                                    <label>སྦྲེལ་ཐག <label style="color: brown;">འདི་ནི་ཧ་ཅང་གི་གལ་ཆེན་ཡིན། དཔེར་ན།
                                            TN693842 འདི་ལྟ་བུའི་ཡི་གེ་གཉིས་དང་ཨང་གྲངས་ ༦ ངེས་པར་དགོས།</label> </label>
