...
<div id="page-wrapper" style="min-height: 345px;">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">ཟུར་སྦྱར།</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="edit-widget.php?id=<?php echo $widget['id']; ?>">བཟོ་བཅོས།</a> | <a href="delete-item.php?id=<?php echo $widget['id']; ?>&item=widget">གསུབ།</a></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
