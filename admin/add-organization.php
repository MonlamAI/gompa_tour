                            ...
                            <form role="form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="street"
                                        placeholder="ལམ་གཞུང་དང་ཁང་ཨང་སོགས་འགོད་དགོས།" value="<?php if (isset($_POST['street'])) {
                                            echo $_POST['street'];
                                        } ?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="address_2"
                                        placeholder="གོང་གསལ་ལྷག་འཕྲོས་ཁ་བྱང་ཡོད་ན་འགོད་དགོས།" value="<?php if (isset($_POST['address_2'])) {
                                ...
                                <div class="form-group col-lg-6">
                                    <label>ཁ་པར་ཨང་།</label>
                                    <input class="form-control" name="phone" placeholder="ཁ་པར་ཨང་འགོད་དགོས།" value="<?php if (isset($_POST['phone'])) {
                                        echo $_POST['phone'];
                                    } ?>">
                                </div>
                                <div class="form-group col-lg-6">
