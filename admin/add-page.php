                        ...
                        <div class="col-lg-12">
                            <form role="form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="title" placeholder="ཤོག་ངོས་ཁ་བྱང་།" value="<?php if(isset($_POST['title'])){ echo $_POST['title'];} ?>">
                                </div>
                                <div class="form-group">
                                    <label>འགྲེལ་བཤད།</label>
                                    <textarea class="form-control" id="editor" name="content" rows="3"><?php if(isset($_POST['content'])){ echo $_POST['content'];} ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label>པར་རིས།</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="slug" placeholder="སྦྲེལ་ཐག" value="<?php if(isset($_POST['slug'])){ echo $_POST['slug'];} ?>">
                                </div>
