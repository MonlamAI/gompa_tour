                                    ...
                                    <form role="form" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="event_tbname"
                                                placeholder="བོད་ཡིག་མཚན་བྱང་འགོད་རོགས།" value="<?php if (isset($_POST['event_tbname'])) {
                                                    echo $_POST['event_tbname'];
                                                } ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>དབྱིན་ཡིག་མཚན་བྱང་།</label>
                                            <input class="form-control" id="event_enname" name="event_enname"
                                                oninput="updateSlug()" placeholder="དབྱིན་ཡིག་མཚན་བྱང་འགོད་རོགས།" value="<?php if (isset($_POST['event_enname'])) {
                                                    echo $_POST['event_enname'];
                                                } ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                                    ...
                                                    <input value="<?php if (isset($_POST['start_date'])) {
                                                        echo date('Y-m-d', strtotime($_POST['start_date']));
                                                    } ?>" class="form-control" name="start_date"
                                                        data-date-format="m/d/Y" id="datepicker">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                                    <label class="control-label"
                                                        for="datepicker-end">མཇུག་མཐའི་ཟླ་ཚེས།</label>
                                                    <input value="<?php if (isset($_POST['end_date'])) {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea style="line-height: 28px;" class="form-control"
                                                name="tb_description" rows="3"><?php if (isset($_POST['tb_description'])) {
                                                    echo $_POST['tb_description'];
                                                } ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>དབྱིན་ཡིག་འགྲེལ་བཤད།</label>
                                            <textarea style="line-height: 28px;" class="form-control"
                                                name="en_description" rows="3"><?php if (isset($_POST['en_description'])) {
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control custom-font-input" value="<?php if (isset($_POST['categories'])) {
                                                        echo $_POST['categories'];
                                                    } ?>" name="categories" placeholder="སྡེ་ཚན་དབྱེ་བ་འཇུག་རོགས།"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                                    ...
                                                    <input class="form-control" name="location"
                                                        placeholder="ས་ཕྱོགས་ནང་འཇུག་བྱ་དགོས།" value="<?php if (isset($_POST['location'])) {
                                                            echo $_POST['location'];
                                                        } ?>">
                                                    ...
                                                    <div class="radio">
                                                        <label>
                                                            <input type="radio" name="status" id="optionsRadios1"
                                                                value="draft" <?php if (isset($_POST) & !empty($_POST)) {
                                                    ...
                                                    <div class="radio">
                                                        <label>
                                                            <input type="radio" name="status" id="optionsRadios2"
                                                                value="review" <?php if (isset($_POST) & !empty($_POST)) {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="slug" name="slug" placeholder="སྦེལ་ཐག་་་"
