                            ...
                            <form role="form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="street"
                                        placeholder="ལམ་གཞུང་དང་ཁང་ཨང་སོགས་འགོད་དགོས།" value="<?php if (isset($post['street'])) {
                                            echo $post['street'];
                                        } ?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="address_2"
                                        placeholder="གོང་གསལ་ལྷག་འཕྲོས་ཁ་བྱང་ཡོད་ན་འགོད་དགོས།" value="<?php if (isset($post['address_2'])) {
                                            echo $post['address_2'];
                                        } ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group col-lg-6">
                                    <label>ཁ་པར་ཨང་།</label>
                                    <input class="form-control" name="phone" placeholder="ཁ་པར་ཨང་འགོད་དགོས།" value="<?php if (isset($post['phone'])) {
                                        echo $post['phone'];
                                    } ?>">
                                </div>
                                <div class="form-group col-lg-6">
                                    <label>གློག་འཕྲིན།</label>
                                    <input class="form-control" name="email" placeholder="གློག་འཕྲིན་ཁ་བྱང་འགོད་དགོས།"
                                ...
                                <div class="form-group col-lg-6">
                                    <label>དྲ་རྒྱ།</label>
                                    <input class="form-control" name="web" placeholder="དྲ་རྒྱའི་ཁ་བྱང་འགོད་དགོས།"
                                        value="<?php if (isset($post['web'])) {
                                            echo $post['web'];
                                        } ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group col-lg-6">
                                    <?php if (isset($post['pic']) && !empty($post['pic'])): ?>
                                        ...
                                        <a
                                            href="delete-pic.php?id=<?php echo urlencode($_GET['id']); ?>&type=organization">པར་རིས་གསུབ།</a>
                                    <?php else: ?>
                                    ...
                                    <?php if (isset($post['sound']) && !empty($post['sound'])): ?>
                                        ...
                                        <a
                                            href="delete-sound.php?id=<?php echo urlencode($_GET['id']); ?>&type=organization">སྒྲ་གསུབ།</a>
                                    <?php else: ?>
