               ...
               $start = ($page > 1) ? ($page * $limit) - $limit : 0;
                ...
                foreach ($results as $row) {
                    ...
                    <a href="tensum.php?url=<?php echo $row['slug']; ?>"><h4 style="color: #1e5fa6;margin: 1px;font-size: 20px;line-height: 35px;" class="card-title"><?php echo $titel ?></h4></a>
                        ...
                        <img style="width: 150px;object-fit: cover;flo;float: left;height: 90px;object-position: top;margin-right: 6px;position: relative;top: 0px;" class="img-fluid rounded" src="<?php echo $row['pic']; ?>" alt="">  
