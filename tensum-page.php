...
<div style="width: 97%!important;"  class="container">
  ...
  <div class="row">
    ...
    <div class="col-lg-8"style="min-height: 100vh;">
            ...
            <form action="tensum-page.php" style="margin-top: 18px;" class="input-group custom-search-form">
        ...
        <label class="form-check-label" for="exampleCheck1"><?php echo htmlspecialchars(translate('pilgrimage'), ENT_QUOTES, 'UTF-8'); ?> </label>
            ...
            if (isset($_GET['search']) && !empty($_GET['search'])) {
               ...
               $start = ($page > 1) ? ($page * $limit) - $limit : 0;
                ...
                $sql = "SELECT *, MATCH(tbtitle, entitle) AGAINST(:searchTerm IN NATURAL LANGUAGE MODE) AS score FROM tensum WHERE MATCH(tbtitle, entitle) 
                ...
                foreach ($results as $row) {
                    ...
                    <a href="tensum.php?url=<?php echo $row['slug']; ?>"><h4 style="color: #1e5fa6;margin: 1px;font-size: 20px;line-height: 35px;" class="card-title"><?php echo $titel ?></h4></a>
                        ...
                        <img style="width: 150px; object-fit: cover; float: left; height: 90px; object-position: top; margin-right: 6px; position: relative; top: 8px;" class="img-fluid rounded" src="<?php echo $row['pic']; ?>" alt="" onerror="this.onerror=null; this.src='vendor/img/noimage.jpg';"> 
              ...
              if($_SESSION['lang'] === 'en'){
               ...
               $start2 = ($page2 > 1) ? ($page2 * $limit2) - $limit2 : 0;
                ...
                // Prepare the full-text search query
                $sql2 = "SELECT * FROM tensum ORDER BY $titel DESC LIMIT :start, :limit";
                ...
                // Calculate total pages
                $totalSql2 = "SELECT COUNT(*) FROM tensum ";
